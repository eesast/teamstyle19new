...
,  # need to complete
    ...
    BuildingType.Berners_Lee: {BuildingAttribute.BUILDING_TYPE: UnitType.PRODUCTION_BUILDING,
                               BuildingAttribute.ORIGINAL_HP: 150, BuildingAttribute.ORIGINAL_ATTACK: None,
                               BuildingAttribute.ORIGINAL_RANGE: 20, BuildingAttribute.TRAGET: SoliderName.PACKET,
    ...
    BuildingType.Bool: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                        BuildingAttribute.ORIGINAL_HP: 300, BuildingAttribute.ORIGINAL_ATTACK: 16,
                        BuildingAttribute.ORIGINAL_RANGE: 36, BuildingAttribute.TRAGET: UnitType.DATA,
                        BuildingAttribute.AGE: Age.BIT, BuildingAttribute.ORIGINAL_RESOURCE: 150,
                        BuildingAttribute.ORIGINAL_BUILDING_POINT: 15, BuildingAttribute.AOE: 0,
                        BuildingAttribute.CD: 1},
    BuildingType.Ohm: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING, BuildingAttribute.ORIGINAL_HP: 280,
    ...
    BuildingType.Mole: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                        ...
                        BuildingAttribute.ORIGINAL_RANGE: 60, BuildingAttribute.TRAGET: UnitType.DATA,
    ...
    BuildingType.Monte_Carlo: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                               ...
                               BuildingAttribute.ORIGINAL_RANGE: 40, BuildingAttribute.TRAGET: UnitType.SUBSTANCE,
    ...
    BuildingType.Larry_Roberts: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                                 BuildingAttribute.ORIGINAL_HP: 180, BuildingAttribute.ORIGINAL_ATTACK: 5,
                                 BuildingAttribute.ORIGINAL_RANGE: 50, BuildingAttribute.TRAGET: UnitType.ALL,
                                 BuildingAttribute.AGE: Age.NETWORK, BuildingAttribute.ORIGINAL_RESOURCE: 250,
    ...
    BuildingType.Robert_Kahn: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                               BuildingAttribute.ORIGINAL_HP: 450, BuildingAttribute.ORIGINAL_ATTACK: 5,
                               BuildingAttribute.ORIGINAL_RANGE: 36, BuildingAttribute.TRAGET: UnitType.DATA,
    ...
    BuildingType.Musk: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                        ...
                        BuildingAttribute.ORIGINAL_RANGE: 24, BuildingAttribute.TRAGET: UnitType.ALL,
    ...
    BuildingType.Hawkin: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                          ...
                          BuildingAttribute.ORIGINAL_RANGE: 20, BuildingAttribute.TRAGET: UnitType.ALL,
                          BuildingAttribute.AGE: Age.AI, BuildingAttribute.ORIGINAL_RESOURCE: 500,
...
OriginalSoliderAttribute = {
    ...
    SoliderName.VOLTAGE_SOURCE: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE,
                                 ...
                                 SoliderAttr.SOLIDER_ORIGINAL_HP: 60, SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 16,
                                 SoliderAttr.ATTACK_RANGE: 24, SoliderAttr.SPEED: 12},
    SoliderName.CURRENT_SOURCE: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE,
                                 SoliderAttr.ACTION_MODE: ActionMode.BASE_ATTACK, SoliderAttr.SOLIDER_ORIGINAL_HP: 100,
                                 SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 160, SoliderAttr.ATTACK_RANGE: 6,
                                 SoliderAttr.SPEED: 20},
    SoliderName.ENIAC: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE, SoliderAttr.ACTION_MODE: ActionMode.MOVING_ATTACK,
                        SoliderAttr.SOLIDER_ORIGINAL_HP: 500, SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 15,
                        SoliderAttr.ATTACK_RANGE: 10, SoliderAttr.SPEED: 6},
    SoliderName.PACKET: {SoliderAttr.SOLIDER_TYPE: UnitType.DATA, SoliderAttr.ACTION_MODE: ActionMode.BASE_ATTACK,
                         SoliderAttr.SOLIDER_ORIGINAL_HP: 70, SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 300,
                         SoliderAttr.ATTACK_RANGE: 6, SoliderAttr.SPEED: 24},
    SoliderName.OPTICAL_FIBER: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE,
                                ...
                                SoliderAttr.ATTACK_RANGE: 40, SoliderAttr.SPEED: 16},
    SoliderName.TURNING_MACHINE: {SoliderAttr.SOLIDER_TYPE: UnitType.DATA,
                                  SoliderAttr.ACTION_MODE: ActionMode.MOVING_ATTACK,
                                  SoliderAttr.SOLIDER_ORIGINAL_HP: 800, SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 10,
                                  SoliderAttr.ATTACK_RANGE: 12, SoliderAttr.SPEED: 4},
    SoliderName.ULTRON: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE,
                         ...
                         SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 500, SoliderAttr.ATTACK_RANGE: 20, SoliderAttr.SPEED: 12},
}
