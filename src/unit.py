...
,  # need to complete
    ...
    BuildingType.Berners_Lee: {BuildingAttribute.BUILDING_TYPE: UnitType.PRODUCTION_BUILDING,
                               ...
                               BuildingAttribute.ORIGINAL_BUILDING_POINT: 36, BuildingAttribute.AOE: None,
                               BuildingAttribute.CD: 3},
    ...
    BuildingType.Turing: {BuildingAttribute.BUILDING_TYPE: UnitType.PRODUCTION_BUILDING,
                          BuildingAttribute.ORIGINAL_HP: 500, BuildingAttribute.ORIGINAL_ATTACK: None,
    ...
    BuildingType.Tony_Stark: {BuildingAttribute.BUILDING_TYPE: UnitType.PRODUCTION_BUILDING,
                              BuildingAttribute.ORIGINAL_HP: 400, BuildingAttribute.ORIGINAL_ATTACK: None,
                              BuildingAttribute.ORIGINAL_RANGE: 10,
                              BuildingAttribute.TRAGET: SoliderName.ULTRON, BuildingAttribute.AGE: Age.AI,
                              BuildingAttribute.ORIGINAL_RESOURCE: 800, BuildingAttribute.ORIGINAL_BUILDING_POINT: 80,
    ...
    BuildingType.Bool: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                        ...
                        BuildingAttribute.ORIGINAL_RANGE: 12, BuildingAttribute.TRAGET: UnitType.DATA,
    ...
    BuildingType.Ohm: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING, BuildingAttribute.ORIGINAL_HP: 220,
                       ...
                       BuildingAttribute.ORIGINAL_RESOURCE: 180, BuildingAttribute.ORIGINAL_BUILDING_POINT: 18,
    ...
    BuildingType.Mole: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                        BuildingAttribute.ORIGINAL_HP: 240, BuildingAttribute.ORIGINAL_ATTACK: 4,
    ...
    BuildingType.Monte_Carlo: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                               BuildingAttribute.ORIGINAL_HP: 320, BuildingAttribute.ORIGINAL_ATTACK: 25,
    ...
    BuildingType.Larry_Roberts: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                                 ...
                                 BuildingAttribute.AGE: Age.NETWORK, BuildingAttribute.ORIGINAL_RESOURCE: 150,
                                 BuildingAttribute.ORIGINAL_BUILDING_POINT: 15, BuildingAttribute.AOE: 2,
                                 BuildingAttribute.CD: 1},
    BuildingType.Robert_Kahn: {BuildingAttribute.BUILDING_TYPE: UnitType.DEFENSIVE_BUILDING,
                               BuildingAttribute.ORIGINAL_HP: 450, BuildingAttribute.ORIGINAL_ATTACK: 0,
                               BuildingAttribute.ORIGINAL_RANGE: 30, BuildingAttribute.TRAGET: UnitType.DATA,
...
OriginalSoliderAttribute = {
    ...
    SoliderName.PACKET: {SoliderAttr.SOLIDER_TYPE: UnitType.DATA, SoliderAttr.ACTION_MODE: ActionMode.BASE_ATTACK,
                         SoliderAttr.SOLIDER_ORIGINAL_HP: 60, SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 300,
    ...
    SoliderName.ULTRON: {SoliderAttr.SOLIDER_TYPE: UnitType.SUBSTANCE,
                         ...
                         SoliderAttr.SOLIDER_ORIGINAL_ATTACK: 500, SoliderAttr.ATTACK_RANGE: 10, SoliderAttr.SPEED: 8},
}
