...
const int OriginalBuildingAttribute[Building_Type][Attr_Num] = {
    ...
    {PRODUCTION_BUILDING, 250,  _NULL,  10,   TURING_MACHINE,  AI,        600,    60,    _NULL,  8},
...
const int OriginalSoldierAttribute[Soldier_Type][Soldier_Attr_Num] = {
    {DATA,      BUILDING_ATTACK,        16,     10,     12,     12},
    {SUBSTANCE, BUILDING_ATTACK,        60,     18,     20,     8},
    {SUBSTANCE, BASE_ATTACK,            40,     160,    3,      15},
    {SUBSTANCE, MOVING_ATTACK,          400,    12,     5,      4},
    {DATA,      BASE_ATTACK,            50,     300,    3,      16},
    {SUBSTANCE, BUILDING_ATTACK,        30,     20,     32,     12},
    {DATA,      MOVING_ATTACK,          300,    8,      6,      6},
    {SUBSTANCE, BUILDING_ATTACK,        200,    500,    15,     8}
};
