...
|-------|---------|---------|---|------|----|-------|-------|---------|---|----|
|布尔|350|16|1|36|数据|0|比特|150|15|布尔代数：有一半的几率攻击无效|
...
|蒙特卡罗|350|25|2|40|实体|0|算法|200|20|蒙特卡罗方法：对单位造成的伤害会乘以一个0~2之间的随机数|
|拉里罗伯茨|220|6|1|50|全部|8|网络|250|25|阿帕网：优先攻击数据包且对数据包造成的伤害*3|
|罗伯特卡恩|520|5|1|36|数据|0|网络|450|45|TCP\IP协议：攻击任何目标均附加其最大生命值百分之10（*科技因数）的伤害|
|马斯克|1000|0|1|24|全部|0|AI|500|50|AI末日论：使其攻击范围内的AI兵种无法移动与攻击|
|霍金|480|∞|2|20|全部|2|AI|500|50|黑洞：你也看到这伤害了，消灭1格和邻格内所有单位|
