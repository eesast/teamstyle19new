...
（3）建筑升级并不会改变建筑种类。例如，在科技3级时，升级一个1级bool，它会变成一个2级bool，还可以继续升级成3级bool，但不能超过3级。
...
# 所有建筑与单位的详细设定
	...
	1.所有给出基础值的实际数值为基础值*（0.5+时代阶段数*0.5），即bit级别的数值为基础值，此后每级增加50%
...
|-------|---------|--|--------|-------|-------|---------|------|
|香农|100|比特流|10|3|比特|100|10|
|戴维南|120|电压源|5|6|电路|120|12|
|诺顿|120|电流源|5|6|电路|120|12|
|冯诺依曼|150|ENIAC|15|15|处理器|150|16|
|伯纳斯李|300|数据包|30|3|网络|360|12|
|高锟|300|光纤|15|8|网络|300|30|
|图灵|500|图灵机|15|20|AI|600|20|
|托尼斯塔克|400|奥创|10|20|AI|1000|80|

|单位|类型|行动模式|基础生命值|基础攻击力|攻击范围|移动速度|
|----|---|-------|---------|---------|-------|------|
|比特流|数据|推塔|20|10|8|8|
|电压源|实体|推塔|60|16|12|6|
|电流源|实体|冲锋|80|160|3|6|
|ENIAC|实体|抗线|500|15|5|3|
|数据包|数据|冲锋|100|300|3|16|
|光纤|实体|推塔|40|15|20|10|
|图灵机|数据|抗线|800|10|10|2|
|奥创|实体|推塔|100|500|10|8|

|防御建筑|基础生命值|基础攻击力|攻击CD|射程|攻击目标|AOE|解锁时代|基础资源|基础建造力|特效|
|-------|---------|---------|---|------|----|-------|-------|---------|---|----|
|布尔|200|16|1|12|数据|0|比特|150|15|布尔代数：有一半的几率攻击无效|
|欧姆|180|10|3|25|实体|3|电路|180|20|欧姆定律：同时击中电压源和电流源时造成4倍伤害|
|摩尔|225|4|1|35|实体|0|处理器|225|25|摩尔定律：优先攻击上回合目标且对一个目标连续攻击时每次伤害*2|
|蒙特卡罗|300|25|2|25|实体|0|算法|300|30|蒙特卡罗方法：对单位造成的伤害会乘以一个0~2之间的随机数|
|拉里罗伯茨|480|5|1|25|全部|2|网络|480|50|阿帕网：优先攻击数据包且对数据包造成的伤害*3|
|罗伯特卡恩|450|0|1|30|数据|0|网络|450|45|TCP\IP协议：攻击任何目标均附加其最大生命值百分之10（*科技因数）的伤害|
|马斯克|1000|0|1|12|全部|0|AI|500|40|AI末日论：使其攻击范围内的AI兵种无法移动与攻击|
|霍金|400|∞|5|11|全部|1|AI|500|50|黑洞：你也看到这伤害了，消灭1格内所有单位|
